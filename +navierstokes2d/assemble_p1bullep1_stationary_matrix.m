  ...
  for el = 1:n_elems
	...
	for m = 1:2
	  for n = 1:4
	    ...
	    if 1
	      % mu derivative:
	      contrib = contrib + navierstokes2d.quadrature5(@(x) navierstokes2d.viscosity_term_1(x, mesh, dof_map, ctx, u_x, u_y, el, basis, i, k, m, n));
	      % epsilon derivative:
	      contrib = contrib + navierstokes2d.quadrature5(@(x) navierstokes2d.viscosity_term_2(x, mesh, dof_map, ctx, u_x, u_y, el, basis, i, k, m, n));
	    end % enable/disable
